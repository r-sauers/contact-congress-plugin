...
class Congress_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->congress, plugin_dir_url( __FILE__ ) . 'css/congress-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->congress, plugin_dir_url( __FILE__ ) . 'js/congress-public.js', array( 'jquery' ), $this->version, false );
