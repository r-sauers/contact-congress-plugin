...
function activate_congress() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-congress-activator.php';
...
function deactivate_congress() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-congress-deactivator.php';
